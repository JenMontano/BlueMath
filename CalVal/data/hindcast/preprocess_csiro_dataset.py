...
csiro_dataset = xr.open_dataset('/Users/sam/jen/code/GeoOcean_codes/CalValWaves/data/hindcast/201402.nc')

csiro_sel = csiro_dataset.isel(latitude=32.502,longitude=-79.099)
